...
namespace crm_api.Models.util
{
    public class ResultCode
    {
        ...
        public static  int PARAMS_TYPE_ERROR = 1003; // 参数类型错误
        ...
        // 系统错误
        public static  int SYSTEM_INNER_ERROR = 40001; // 系统内部错误

        // 数据错误
        public static  int DATA_NOT_FOUND = 50001; // 数据未找到
        public static  int DATA_IS_WRONG = 50002;// 数据有误
        public static  int DATA_ALREADY_EXISTED = 50003;// 数据已存在
